...
function getHTML() {
    ...
    body { background: var(--bg); color: #fff; font-family: monospace; margin: 0; padding: 20px; text-transform: uppercase; }
    ...
    <script>
        ...
        ws.onmessage=(e)=>{
            ...
            r.innerHTML='<span>'+new Date().toLocaleTimeString()+'</span><span style="color:#888">['+d.exch.toUpperCase()+']</span><span>'+d.symbol+'</span><span>'+d.side.toUpperCase()+'</span><span style="text-align:right">$'+d.value.toLocaleString()+'</span>';
